...
messages_en = {
	...
	My name is Alexis Vallet. I'm a Ph.D. student at Kyushu University, Japan. I do computer vision research, focusing on deep learning for artwork annotation. You can check out my work on <a href="https://github.com/alexisVallet">Github</a> or on my <a href="http://alexisvallet.github.io/">blog</a>.
      ...
      <p>
	Like what I do? I am currently looking for companies to collaborate with. You can contact me <a href="mailto:alexis.vallet@gmail.com">here</a>.
      </p>""",
    'acknowledgements_header': 'Acknowledgements',
    'acknowledgements_body': """<p>
	This research wouldn't have been possible without support from Kyushu University, my family and my thesis advisor Hiroyasu Sakamoto.
      </p>
      <p>
	Illustrations on this website are all licensed under some creative commons license, see the attribution details on each thumbnail. I do not profit from this website in any fashion, and only modified the original images to resize them to thumbnail size and convert them to the jpeg format. If your illustration was misattributed, please contact me <a href="mailto:alexis.vallet@gmail.com">here</a>.
      </p>"""
}
