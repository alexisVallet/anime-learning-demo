...
templates['test_samples'] = template({"1":function(depth0,helpers,partials,data) {
  var stack1, helper, options, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, blockHelperMissing=helpers.blockHelperMissing, buffer = "<div class=\"thumbnail\">\n  <img data-src="
    ...
    + " class=\"owl-lazy\">\n  <div class=\"caption\">\n";
  stack1 = ((helper = (helper = helpers.predictions || (depth0 != null ? depth0.predictions : depth0)) != null ? helper : helperMissing),(options={"name":"predictions","hash":{},"fn":this.program(2, data),"inverse":this.noop,"data":data}),(typeof helper === functionType ? helper.call(depth0, options) : helper));
